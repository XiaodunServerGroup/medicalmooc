...
EMAIL_HOST = ENV_TOKENS.get('EMAIL_HOST', 'smtp.126.com')
...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'xiaodunxin')
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', '123456qr')
