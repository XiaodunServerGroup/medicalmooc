...
EMAIL_HOST = ENV_TOKENS.get('EMAIL_HOST', 'smtp.exmail.qq.com')
...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'servicemooc@pmph.com')
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', 'pmph59787576')
