...
TECH_SUPPORT_EMAIL = 'servicemooc@test.com'
CONTACT_EMAIL = 'servicemooc@test.com'
BUGS_EMAIL = 'servicemooc@test.com'
ADMINS = ()
MANAGERS = ADMINS
...
main_vendor_js = [
    ...
    'js/vendor/ova/gettext.js',
    #'js/vendor/ova/annotator-full.min.js',
...
wechat_main_js = [
    ...
    'js/vendor/swfobject/swfobject.js',
    'js/vendor/jquery.ba-bbq.min.js',
    #'js/vendor/ova/annotator-full.min_ori.js',
    'js/vendor/ova/video.dev.js',
    'js/vendor/ova/vjs.youtube.js',
    'js/vendor/ova/rangeslider.js',
    'js/vendor/ova/share-annotator.js',
